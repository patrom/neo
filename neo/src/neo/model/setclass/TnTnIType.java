...
public class TnTnIType extends TnIType {
	...
	case 3:
		...
		lists3[i][1] 
		    = "      ".concat("[").concat(
						  prime3[i].tntnitypeToString()
						  ).concat("]");
		lists3[i][2] 
		    = "  ".concat("<").concat(
					      prime3[i].ivectorToString()
					      ).concat(">");
		lists3[i][3] 
		    = "       ".concat("[").concat(
						   prime3[i].m7setToString()
						   ).concat("]");
		lists3[i][4] 
		    = "     ".concat(" ").concat(
						 prime3[i].symmetryToString()
						 ).concat(" ");
	    }
	    return lists3;
	case 4:
		...
		lists4[i][1] 
		    = "     ".concat("[").concat(
						 prime4[i].tntnitypeToString()
						 ).concat("]");
		lists4[i][2] 
		    = "  ".concat("<").concat(
					      prime4[i].ivectorToString()
					      ).concat(">");
		lists4[i][3] 
		    = "     ".concat("[").concat(
						 prime4[i].m7setToString()
						 ).concat("]");
		lists4[i][4] 
		    = "     ".concat(" ").concat(
						 prime4[i].symmetryToString()
						 ).concat(" ");
	    }
	    return lists4;
	case 5:
		...
		lists5[i][1] 
		    = "     ".concat("[").concat(
						 prime5[i].tntnitypeToString()
						 ).concat("]");
		lists5[i][2] 
		    = "  ".concat("<").concat(
					      prime5[i].ivectorToString()
					      ).concat(">");
		lists5[i][3] 
		    = "    ".concat("[").concat(
						prime5[i].m7setToString()
						).concat("]");
		lists5[i][4] 
		    = "     ".concat(" ").concat(
						 prime5[i].symmetryToString()
						 ).concat(" ");
	    }
	    return lists5;
	case 6:
		...
		lists6[i][1] 
		    = "    ".concat("[").concat(prime6[i].tntnitypeToString()
						).concat("]");
		lists6[i][2] 
		    = "  ".concat("<").concat(prime6[i].ivectorToString()
					      ).concat(">");
		lists6[i][3] 
		    = "    ".concat("[").concat(prime6[i].m7setToString()
						).concat("]");
		lists6[i][4] 
		    = "     ".concat(" ").concat(prime6[i].symmetryToString()
						 ).concat(" ");
		lists6[i][5] 
		    = "   ".concat(" ").concat(prime6[i].combinatorialToString()
					       ).concat(" ");
	    }
	    return lists6;
	case 7:
		...
		lists7[i][1] 
		    = "   ".concat("[").concat(
					       prime7[i].tntnitypeToString()
					       ).concat("]");
		lists7[i][2] 
		    = "   ".concat("<").concat(
					       prime7[i].ivectorToString()
					       ).concat(">");
		lists7[i][3] 
		    = "      ".concat(" ").concat(
						  prime7[i].symmetryToString()
						  ).concat(" ");
	    }
	    return lists7;
	case 8:
		...
		lists8[i][1] 
		    = "   ".concat("[").concat(
					       prime8[i].tntnitypeToString()
					       ).concat("]");
		lists8[i][2] 
		    = "   ".concat("<").concat(
					       prime8[i].ivectorToString()
					       ).concat(">");
		lists8[i][3] 
		    = "      ".concat(" ").concat(
						  prime8[i].symmetryToString()
						  ).concat(" ");
	    }
	    return lists8;
	case 9:
		...
		lists9[i][1] 
		    = "   ".concat("[").concat(
					       prime9[i].tntnitypeToString()
					       ).concat("]");
		lists9[i][2] 
		    = "    ".concat("<").concat(
						prime9[i].ivectorToString()
						).concat(">");
		lists9[i][3] 
		    = "       ".concat(" ").concat(
						   prime9[i].symmetryToString()
						   ).concat(" ");
	    }
	    return lists9;
	default:
