...
//	private List<MusicalStructure> melodies = new ArrayList<MusicalStructure>();
	...
	public List<NoteList> getMelodies() {
//		extractSentences(partitions);
		return noteList;
	}
	
	@Override
	public void setMelodies(List<NoteList> melodies) {
...
//	}
	...
	public MusicVariableAtonal2(MusicVariableAtonal2 musicVariable) throws JMException {
		this.noteList = cloneMotives(musicVariable.getMelodies());
...
//		this.harmonyObjects = extractHarmonyObjects(melodies);	
	...
	public MusicVariableAtonal2(List<NoteList> noteList2, int size2) {
...
//	}
//
	private List<NoteList> cloneMotives(List<NoteList> noteLists) {
		List<NoteList> motives = new ArrayList<>();
		for (NoteList noteList : noteLists) {
			...
			NoteList motive = new NoteList(noteList.getPosition(), newNotePositions);
			motives.add(motive);
		}
		return motives;
	}
